          ...
          <div className="profile-hero-info">
            ...
            <div className="profile-hero-meta">
              ...
              <span className={`profile-role-badge ${user?.rol === 'admin' ? 'role-admin' : 'role-user'}`}>
                ...
                {{ admin: 'Administrador', vendedor: 'Vendedor', vendedor_2: 'Vendedor 2', gerente: 'Gerente', auditor: 'Auditor' }[user?.rol] || 'Sin rol asignado'}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="profile-stats-bar">
        ...
        <div className="profile-stat">
          ...
          <div>
            ...
            <div className="profile-stat-value">{{ admin: 'Administrador', vendedor: 'Vendedor', vendedor_2: 'Vendedor 2', gerente: 'Gerente', auditor: 'Auditor' }[user?.rol] || 'Sin rol asignado'}</div>
          </div>
        </div>
        <div className="profile-stat-divider" />
        <div className="profile-stat">
        ...
        <div className="profile-field-grid">
          ...
          <div className="profile-field">
            ...
            <div>
              ...
              <p>{{ admin: 'Administrador', vendedor: 'Vendedor', vendedor_2: 'Vendedor 2', gerente: 'Gerente', auditor: 'Auditor' }[user?.rol] || 'Sin rol asignado'}</p>
            </div>
          </div>
          <div className="profile-field">
