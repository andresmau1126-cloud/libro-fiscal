...
for key in DEBUG ALLOWED_HOSTS CSRF_TRUSTED_ORIGINS DATABASE_URL RENDER_DATABASE_URL DB_ENGINE DB_NAME DB_USER DB_HOST DB_PORT EMAIL_HOST EMAIL_PORT EMAIL_HOST_USER DEFAULT_FROM_EMAIL DJANGO_SETTINGS_MODULE; do
